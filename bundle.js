...
var APP_ID = 'NIBvX6tQOTPhLV3tY00uPii6-gzGzoHsz';
var APP_KEY = 'bkLlTnqDmOrBEKTkqCnsUO92';
...
var app = new _vue2.default({
  ...
  methods: {
    ...
    addTodo: function addTodo() {
      var times = new Date();
      var currentTime = times.getFullYear() + "年" + (times.getMonth() + 1) + "月" + times.getDate() + "日";
      this.todoList.push({
        title: this.newTodo,
    ...
    isdelete: function isdelete(item) {
      var index = this.todoList.indexOf(item);
      this.todoList.splice(index, 1);
      // this.saveTodos();
      this.saveOrUpdateTodos(); // 不能用 saveTodos 了
    },
    changeBtn: function changeBtn(type) {
      //解构赋值
